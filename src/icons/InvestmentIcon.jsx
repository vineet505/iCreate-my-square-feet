...
const InvestmentIcon = () => {
  return (
    ...
    >
      <g>
        <path
          d="M32.2,45.1c1.1,0,2-0.9,2-2v-1h0.7c3.3,0,6.1-2.7,6.1-6c0-3.3-2.7-6-6.1-6h-5.2c-1.1,0-2.1-0.9-2.1-2s0.9-2,2.1-2H38
        ...
        />
        <path
          d="M8.4,31.7c0.5,0,0.9-0.2,1.2-0.4l7.1-5.6c0.9-0.7,1-1.9,0.3-2.8c-0.7-0.9-1.9-1-2.8-0.3l-3.6,2.9
        ...
        />
        <path
          d="M63,44.8l-3.9-8.5c-0.2-0.5-0.6-0.9-1.2-1.1c-0.5-0.2-1.1-0.1-1.6,0.1l-8.1,4c-1,0.5-1.4,1.7-0.9,2.7
