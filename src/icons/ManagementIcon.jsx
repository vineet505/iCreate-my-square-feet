...
const ManagementIcon = () => {
  return (
    ...
    >
      <g>
        <path
          d="M46.3,12.9c-3.6,0-6.5,2.9-6.5,6.5c0,0.2,0,0.5,0,0.7l-2.4,1.6l-2.7-0.9c-0.8-2.7-3.3-4.6-6.2-4.6c-3.6,0-6.5,2.9-6.5,6.5
        ...
        />
        <path
          d="M57,5.9H7c-3.4,0-6.3,2.8-6.3,6.3v26.4c0,3.4,2.8,6.3,6.3,6.3h22.8v8.8H18.8c-1.2,0-2.3,1-2.3,2.3s1,2.3,2.3,2.3h26.4
