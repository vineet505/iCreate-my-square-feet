...
import { UploadRegionIconUrl } from "@/static/ApiEndpoints";
import { getBase64 } from "@/utility/utils";

export const RegionImageComponent = ({ ImageUrl, regionId, imageId }) => {
  ...
  const onChange = (info) => {
    ...
    if (status === "done") {
      message.success(`Region Image Updated Successfully.`);
